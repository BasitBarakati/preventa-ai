    ...
    const start = () => {
      ...
      ctx = gsap.context(() => {
        ...
        gsap.fromTo(
          ...
          { scale: 1, opacity: 1, duration: 0.8, ease: "back.out(1.6)", stagger: 0.14, delay: 0.85 },
        );
      }, root);
    };
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0" aria-hidden="true">
        <div className="absolute inset-0 bg-[radial-gradient(60rem_42rem_at_78%_30%,rgba(31,138,138,0.16),transparent_60%)]" />
        <div className="absolute inset-0 bg-[radial-gradient(46rem_36rem_at_12%_82%,rgba(232,168,124,0.14),transparent_62%)]" />
        <div className="absolute inset-0 bg-[radial-gradient(38rem_30rem_at_45%_8%,rgba(11,61,95,0.10),transparent_65%)]" />
        {/* fine meridian grid */}
        <div className="absolute inset-0 opacity-[0.35] [background-image:linear-gradient(rgba(11,61,95,0.05)_1px,transparent_1px),linear-gradient(90deg,rgba(11,61,95,0.05)_1px,transparent_1px)] [background-size:72px_72px] [mask-image:radial-gradient(60rem_60rem_at_50%_40%,black,transparent_75%)]" />
      </div>
      ...
      <div className="wrap relative z-10 grid items-center gap-10 lg:grid-cols-[1.04fr_0.96fr]">
        ...
        <div>
          ...
          <p className="hero-el mt-7 max-w-xl text-[16.5px] leading-[1.7] text-ink/70">
            <strong className="font-semibold text-ink">Phronesis AI</strong> is the AI health
            promotion platform and brain trust bridging evidence-based judgments with public
            health action — from population health assessment to community-validated wellness,
            always <em className="font-display text-teal">human-led</em>.
          </p>
        ...
        <div className="hero-el relative mx-auto h-[380px] w-full max-w-[560px] sm:h-[460px] lg:h-[560px]">
          {/* breathing halo */}
          <div
